...
def get_feedback_counts():
    ...
    teacher1_negative_count = df1['teacher1'].get(-1,0)
    teacher1_neutral_count = df1['teacher1'].get(0,0)
    teacher1_positive_count = df1['teacher1'].get(1,0)

    df1 = df.groupby('teacher2score').count()[['teacher2']]
    teacher2_negative_count = df1['teacher2'].get(-1,0)
    teacher2_neutral_count = df1['teacher2'].get(0,0)
    teacher2_positive_count = df1['teacher2'].get(1,0)

    df1 = df.groupby('teacher3score').count()[['teacher3']]
    teacher3_negative_count = df1['teacher3'].get(-1,0)
    teacher3_neutral_count = df1['teacher3'].get(0,0)
    teacher3_positive_count = df1['teacher3'].get(1,0)

    df1 = df.groupby('teacher4score').count()[['teacher4']]
    teacher4_negative_count = df1['teacher4'].get(-1,0)
    teacher4_neutral_count = df1['teacher4'].get(0,0)
    teacher4_positive_count = df1['teacher4'].get(1,0)

    df1 = df.groupby('teacher5score').count()[['teacher5']]
    teacher5_negative_count = df1['teacher5'].get(-1,0)
    teacher5_neutral_count = df1['teacher5'].get(0,0)
    teacher5_positive_count = df1['teacher5'].get(1,0)

    df1 = df.groupby('teacher6score').count()[['teacher6']]
    teacher6_negative_count = df1['teacher6'].get(-1,0)
    teacher6_neutral_count = df1['teacher6'].get(0,0)
    teacher6_positive_count = df1['teacher6'].get(1,0)
